        ...
        <div className="flex w-full items-center justify-center p-6 md:p-10 mt-70">
            <div className="text-center font-extralight text-4xl font-sans tracking-widest p-1">
                ...
                <div className="grid min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
                    <svg className="w-16 h-16 animate-spin dark:text-zinc-950 text-zinc-50/30" viewBox="0 0 64 64" fill="none"
                        ...
                        <path
                            ...
                            stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" className="dark:text-zinc-50 text-zinc-950">
                        </path>
                    </svg>
                </div>
            </div>
